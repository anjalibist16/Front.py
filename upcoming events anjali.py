...
#     mode = mode_var.get()
#     if mode == "Student":
#         event_names = ["Holi", "Diwali", "Christmas", "New Year", "Birthday"]
#     elif mode == "Administrator":
#         event_names = ["Holi", "Diwali", "Christmas", "New Year", "Sarswati puja", "Valentine's Day", "Sports", "Tours", ""]
...
#     resized_image2 = image2.resize((100, 100), Image.BILINEAR)
#     img2 = ImageTk.PhotoImage(resized_image2)
#     image_label_frame = Label(root, bg='#CDC5C5')
#     image_label_frame.place(x=650, y=150, width=600, height=450)
# except FileNotFoundError:
#     print("Image file not found.")
# except Exception as e:
#     print("An error occurred while loading the image:", e)
...
# try:
#     image3 = Image.open('tihar.jpg')
#     resized_image3 = image3.resize((100, 100), Image.BILINEAR)
...
#     resized_image4 = image4.resize((100, 100), Image.BILINEAR)
...
#     resized_image4 = image4.resize((100, 100), Image.BILINEAR)
#     img5= ImageTk.PhotoImage(resized_image4)
# except FileNotFoundError:
#     print("Image file not found.")
# except Exception as e:
#     print("An error occurred while loading the image:", e)
...
# try:
#     image6 = Image.open('dashain.jpg')
#     resized_image4 = image4.resize((100, 100), Image.BILINEAR)
#     img6 = ImageTk.PhotoImage(resized_image4)
# except FileNotFoundError:
#     print("Image file not found.")
# except Exception as e:
#     print("An error occurred while loading the image:", e)
...
# try:
#     image7 = Image.open('sports.jpg')
#     resized_image4 = image4.resize((100, 100), Image.BILINEAR)
#     img7 = ImageTk.PhotoImage(resized_image4)
# except FileNotFoundError:
#     print("Image file not found.")
# except Exception as e:
#     print("An error occurred while loading the image:", e)
...
#     resized_image4 = image4.resize((100, 100), Image.BILINEAR)
#     img8 = ImageTk.PhotoImage(resized_image4)
# except FileNotFoundError:
#     print("Image file not found.")
# except Exception as e:
#     print("An error occurred while loading the image:", e)
...
# # Add more try-except blocks for additional images
...
# of unity and renewal.""", bg='#ADD8E6', font=('JejuMyeongjo',10,'normal'))
# event_text.place(x=30, y=290)

# frame = Frame(root, width=550, height=75, bg="white")
# frame.place(x=680, y=180)
...
def update_image():
    ...
    if selected_event == "Holi":
        ...
        image_label_frame.config(image=img8)
    elif selected_event == "sarswatipuja":
        image_label_frame.config(image=img8)
...
try:
    image4 = Image.open('christmas.jpg')
    resized_image4 = image4.resize((100, 100), Image.BILINEAR)
    img4 = ImageTk.PhotoImage(resized_image4)
except FileNotFoundError:
    print("Image file not found.")
...
try:
    image5 = Image.open('newyear.jpg')
    resized_image5 = image5.resize((100, 100), Image.BILINEAR)
...
try:
    ...
    resized_image6 = image6.resize((100, 100), Image.BILINEAR)
...
try:
    ...
    resized_image7 = image7.resize((100, 100), Image.BILINEAR)
...
try:
    image8 = Image.open('tour.jpg')
    resized_image8 = image8.resize((100, 100), Image.BILINEAR)
...
try:
    image8 = Image.open('sarswatipuja.jpg')
    resized_image8 = image8.resize((100, 100), Image.BILINEAR)
    img8 = ImageTk.PhotoImage(resized_image8)
except FileNotFoundError:
    print("Image file not found.")
...
event_names = ["Holi", "tihar", "Christmas", "New Year","Valentinne's Day","Dports","Dashain","tour"]
event_name_var = StringVar()
event_name_var.set(event_names[0])
