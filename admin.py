...
class AdminRegister:
    ...
    def validate_fields(self):
        ...
        if (self.f_name_entry.get() and self.l_name_entry.get() and self.contact_entry.get() and
                self.password_entry.get() and self.Day.get() != 'Day' and self.Months.get() != 'Months' and self.role_entry.get()):
